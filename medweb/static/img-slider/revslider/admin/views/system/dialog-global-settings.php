...
<div id="dialog_general_settings" title="<?php _e("General Settings",'revslider'); ?>" style="display:none;">
    ...
    <a class="button_save_general_settings button-primary" original-title=""><?php _e("Update",'revslider'); ?></a>
		...
		<form name="form_general_settings" id="form_general_settings">
			...
			<table class="form-table">				
				<tbody>
                    ...
                    <tr valign="top">
                        <th scope="row">
                            <?php _e("Enable Dev Mode:",'revslider'); ?>
                        </th>
                        <td>
                            <span id="enable_dev_mode_wrapper" class="radio_settings_wrapper">
                                <div class="radio_inner_wrapper">
                                    <input type="radio" id="" value="on" name="enable_dev_mode" <?php checked($enable_dev_mode, 'on'); ?>>
                                    <label for="" style="cursor:pointer;"><?php _e("On",'revslider'); ?></label>
                                </div>

                                <div class="radio_inner_wrapper">
                                    <input type="radio" id="" value="off" name="enable_dev_mode" <?php checked($enable_dev_mode, 'off'); ?>>
                                    <label for="" style="cursor:pointer;"><?php _e("Off",'revslider'); ?></label>
                                </div>
                            </span>
                            <div class="description_container">
                                <span class="description"><?php _e("Set environment mode to development. It displays errors in this mode.",'revslider'); ?></span>
                            </div>
                        </td>
                    </tr>
                    <tr valign="top">
                        <th scope="row">
                            <?php _e("Set Logging Level:",'revslider'); ?>
                        </th>
                        <td>
                            <span id="logging_level_wrapper" class="radio_settings_wrapper">
                                <div class="radio_inner_wrapper">
                                    <input type="radio" id="" value="0" name="logging_level" <?php checked($logging_level, '0'); ?>>
                                    <label for="" style="cursor:pointer;"><?php _e("Disables logging",'revslider'); ?></label>
                                </div>
                                <div class="radio_inner_wrapper">
                                    <input type="radio" id="" value="1" name="logging_level" <?php checked($logging_level, '1'); ?>>
                                    <label for="" style="cursor:pointer;"><?php _e("Error Messages",'revslider'); ?></label>
                                </div>
                                <div class="radio_inner_wrapper">
                                    <input type="radio" id="" value="2" name="logging_level" <?php checked($logging_level, '2'); ?>>
                                    <label for="" style="cursor:pointer;"><?php _e("Debug Messages",'revslider'); ?></label>
                                </div>
                                <div class="radio_inner_wrapper">
                                    <input type="radio" id="" value="3" name="logging_level" <?php checked($logging_level, '3'); ?>>
                                    <label for="" style="cursor:pointer;"><?php _e("Informational Messages",'revslider'); ?></label>
                                </div>
                                <div class="radio_inner_wrapper">
                                    <input type="radio" id="" value="4" name="logging_level" <?php checked($logging_level, '4'); ?>>
                                    <label for="" style="cursor:pointer;"><?php _e("All Messages",'revslider'); ?></label>
                                </div>
                            </span>
                            <div class="description_container">
                                <span class="description"><?php _e("Sets level of loggins to be logged to /application/logs",'revslider'); ?></span>
                            </div>
                        </td>
                    </tr>
                    <tr valign="top">
                        <th scope="row">
                            <?php _e("Force Use of PclZip Library:",'revslider'); ?>
                        </th>
                        <td>
                            <span id="force_pclzip_wrapper" class="radio_settings_wrapper">
                                <div class="radio_inner_wrapper">
                                    <input type="radio" id="" value="on" name="force_pclzip" <?php checked($force_pclzip, 'on'); ?>>
                                    <label for="" style="cursor:pointer;"><?php _e("On",'revslider'); ?></label>
                                </div>

                                <div class="radio_inner_wrapper">
                                    <input type="radio" id="" value="off" name="force_pclzip" <?php checked($force_pclzip, 'off'); ?>>
                                    <label for="" style="cursor:pointer;"><?php _e("Off",'revslider'); ?></label>
                                </div>
                            </span>
                            <div class="description_container">
                                <span class="description"><?php _e("Use PclZip, instead of ZipArchive. Can help in case of problems with import and update features.",'revslider'); ?></span>
                            </div>
                        </td>
                    </tr>
                    <tr valign="top">
