...
class RevSliderOperations extends RevSliderElementsBase{
	...
	<head>
		...
		<?php if ($slider->getParam('typewriter_defaults_enabled', 'false') == 'true') : ?>
			<script type="text/javascript" src="<?php echo $path_js; ?>revolution.addon.typewriter.min.js"></script>
		<?php endif; ?>
...
ob_end_clean();
		...
		if($export_real){ //only include if real export
            ...
            if(!$usepcl){
                ...
                if ($slider->getParam('typewriter_defaults_enabled', 'false') == 'true') {
                    $zip->addFile(RS_TYPEWRITER_PLUGIN_PATH.'public/assets/js/revolution.addon.typewriter.min.js', PCLZIP_OPT_REMOVE_PATH, RS_TYPEWRITER_PLUGIN_PATH.'public/assets/js/', PCLZIP_OPT_ADD_PATH, 'js/');
                }
